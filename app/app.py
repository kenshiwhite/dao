...
# Advanced Frontend with Gradio
with gr.Blocks() as demo:

    gr.Markdown("# CLIP-based Image Search with Zero-Shot Classification")
    gr.Markdown("Search for images using text or an example image, and see zero-shot classification results for the top matches!")
    ...
    3. **Results**: The top matching images and their classification results are displayed.
    """)
